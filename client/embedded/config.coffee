exports.config =
  ...
  files:
    javascripts:
      joinTo:
        'javascripts/embedded.js': /^app/
        'javascripts/embedded-vendor.js': /^vendor/
    ...
    stylesheets:
      joinTo:
        'stylesheets/embedded-bootstrap.css': /^app(\/|\\)stylesheets(\/|\\)bootstrap/
        'stylesheets/embedded-custom.css': /^app(\/|\\)stylesheets(\/|\\)(?!bootstrap)/
        'stylesheets/embedded.css': /^(app|vendor)/
    ...
    templates:
      joinTo: 'javascripts/embedded.js'
  ...
  conventions:
    ignored: (path)->
      ...
      else if path.match(/^app(\/|\\)stylesheets(\/|\\)selectize/)
        return !path.match(/^app(\/|\\)stylesheets(\/|\\)selectize(\/|\\)selectize.bootstrap2\.less/)
